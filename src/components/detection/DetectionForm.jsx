...
const messageTypes = [
  { id: 'email', name: 'Email', description: 'Check for spam in email messages' },
  { id: 'sms', name: 'SMS', description: 'Analyze SMS/text messages for spam content' },
  { id: 'social', name: 'Social Media', description: 'Detect spam in social media posts and messages' }
]

// Example messages for each platform type
const exampleMessages = {
  email: "Dear valued customer, Congratulations! You've been selected to receive a free $1000 gift card. Click here to claim your prize now: http://claim-your-prize.com",
  ...
  social: "😍 OMG! I made $5,000 in just one week working from home! DM me to learn my secret method and start earning passive income today! 💰💯 #earnmoney #workfromhome"
}
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-gray-600 mb-4">
              Enter your message below and select the platform to check if it's spam.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <textarea
                ...
                className="input font-mono text-sm resize-none custom-scrollbar bg-gray-50"
