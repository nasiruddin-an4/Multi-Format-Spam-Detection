...
const DetectionPage = () => {
  ...
  const renderSpamTips = () => (
    <div className="bg-white rounded-xl shadow-lg p-6 space-y-6 overflow-hidden">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-2">How to Identify Spam</h3>
        <div className="space-y-3">
          <div className="flex gap-3 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Messages that create a sense of urgency or time pressure to act immediately are often spam.</p>
            </div>
          </div>
          ...
          <div className="flex gap-3 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Shortened URLs or links with misspelled domain names are common in spam messages.</p>
            </div>
          </div>
          ...
          <div className="flex gap-3 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Offers of free prizes, massive discounts, or unexpected winnings are typical spam tactics.</p>
            </div>
          </div>
          ...
          <div className="flex gap-3 items-start">
            ...
            <div>
              <h4 className="font-medium text-gray-900">Poor Grammar & Spelling</h4>
              <p className="text-sm text-gray-600">Legitimate organizations typically have professional communications without obvious errors.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-2">How to Stay Safe</h3>
        <ul className="list-disc pl-5 space-y-2 text-sm text-gray-600">
          <li>Never click on suspicious links in emails or messages</li>
          <li>Don't share personal information in response to unexpected requests</li>
    ...
    stats ? (
      <div className="bg-white rounded-xl shadow-lg p-6 space-y-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-danger-50 p-4 rounded-lg text-center">
            ...
            <p className="text-2xl font-bold text-danger-600">{stats.totalSpam}</p>
          </div>
          <div className="bg-success-50 p-4 rounded-lg text-center">
            <p className="text-sm text-gray-500">Legitimate</p>
            <p className="text-2xl font-bold text-success-600">{stats.totalNonSpam}</p>
          </div>
          <div className="bg-primary-50 p-4 rounded-lg text-center">
            <p className="text-sm text-gray-500">Spam Rate</p>
            <p className="text-2xl font-bold text-primary-600">{stats.spamRate}%</p>
          </div>
        </div>
        
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-3">Detection by Platform</h3>
          <div className="space-y-3">
              ...
              data.total > 0 && (
                <div key={platform} className="bg-gray-50 p-3 rounded-lg">
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-sm text-gray-500">{data.total} scans</span>
                  </div>
                  ...
                  <div className="flex justify-between mt-1 text-xs">
                    <span className="text-danger-600">{data.spam} spam ({((data.spam / data.total) * 100).toFixed(1)}%)</span>
                    <span className="text-success-600">{data.total - data.spam} legitimate</span>
                  </div>
                </div>
              )
            ))}
        ...
        {Object.keys(recentByPlatform).length > 0 && (
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Recent Detections by Platform</h3>
            <div className="space-y-3">
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-xs px-2 py-0.5 rounded-full ${
                      item.isSpam ? 'bg-danger-100 text-danger-700' : 'bg-success-100 text-success-700'
                    }`}>
      ...
      <div className="bg-white rounded-xl shadow-lg p-10 text-center">
        ...
        <p className="text-gray-500 max-w-md mx-auto">
          Start analyzing messages to generate detection statistics. Your history will be stored locally for your privacy.
        </p>
      </div>
    )
  )
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pt-28 pb-12 overflow-hidden">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-primary-500/10 to-accent-500/10 rounded-2xl p-8 mb-8 shadow-md overflow-hidden relative">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-700 mb-6">
            ...
            with our advanced multi-format detection system powered by machine learning.
          </p>
        ...
        <div className="lg:col-span-2 space-y-6">
          {activeTab === 'form' && (
            <>
              ...
              {result && (
                <div className={`mt-6 transition-all duration-500 ${animateResult ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-4'}`}>
            ...
            {filteredHistory.length > 0 ? (
              <>
                <div className="text-xs text-gray-500 mb-2">
                  Showing {filteredHistory.length} of {detectionHistory.length} detections
                </div>
              ...
              <div className="text-center py-10 border border-dashed rounded-lg">
                ...
                <p className="text-gray-500 font-medium">No detection history</p>
