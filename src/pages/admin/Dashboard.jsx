...
const Dashboard = () => {
  ...
  const spamPercentage = stats.totalMessages > 0 
    ...
    <div className="animate-fade-up">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div className="bg-white shadow rounded-lg p-6">
          <h2 className="text-lg font-medium text-gray-900 mb-6">Message Type Distribution</h2>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div 
                  ...
                  style={{ width: `${stats.totalMessages > 0 ? (stats.messagesByType.email / stats.totalMessages) * 100 : 0}%` }} 
                ></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div 
                  ...
                  style={{ width: `${stats.totalMessages > 0 ? (stats.messagesByType.sms / stats.totalMessages) * 100 : 0}%` }} 
                ></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div 
                  ...
                  style={{ width: `${stats.totalMessages > 0 ? (stats.messagesByType.social / stats.totalMessages) * 100 : 0}%` }} 
                ></div>
              </div>
            </div>
          </div>
              ...
              {stats.recentActivity.map((activity, index) => (
                <div key={index} className="flex items-start pb-4 border-b border-gray-100">
                  <div className={`flex-shrink-0 h-8 w-8 rounded-full flex items-center justify-center ${
                    activity.isSpam ? 'bg-danger-100 text-danger-600' : 'bg-success-100 text-success-600'
                  }`}>
                    {activity.isSpam ? (
                  ...
                  <div className="ml-3 flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      {activity.isSpam ? 'Detected spam' : 'Scanned message'} ({activity.type})
                    </p>
